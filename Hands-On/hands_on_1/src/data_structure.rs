...
impl Tree {
    ...
    fn rec_validate_max_heap(&self, node_id: Option<usize>, index: usize, parent_value: u32) -> bool {
        if let Some(id) = node_id {
            ...
            let right_valid = self.rec_validate_max_heap(node.id_right, 2 * index + 2, current_value);
